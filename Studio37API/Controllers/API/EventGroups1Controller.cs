...
{
    public class EventGroups1Controller : ApiController
    {
        private DataBaseModels db = new DataBaseModels();

        // GET: api/EventGroups1
        public IQueryable<EventGroup> GetEventGroups()
        {
            return db.EventGroups;
        }

        // GET: api/EventGroups1/5
